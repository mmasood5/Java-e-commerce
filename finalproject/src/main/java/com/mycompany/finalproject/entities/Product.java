 ...
 */
package com.mycompany.finalproject.entities;
...
public class Product {
    ...
    public String toString() {
        return "Products{" + "pId=" + pId + ", pName=" + pName + ", pDescription=" + pDescription + ", pPhoto=" + pPhoto + ", pPrice=" + pPrice + ", pDiscount=" + pDiscount + ", pQuantity=" + pQuantity + '}';
    }
